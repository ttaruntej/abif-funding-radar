...
const KNOWN_RECORD_REMEDIATIONS = [
    ...
    {
        names: ['ADB FinTech Institute', 'ADB Ventures'],
        links: ['https://www.adb.org/what-we-do/sectors/finance/fintech', 'https://ventures.adb.org/'],
        patch: {
            name: 'ADB Ventures',
    ...
    {
        names: ['Clean Energy International Incubation Centre', 'Clean Energy International Incubation Centre (CEIIC)'],
        links: ['https://socialalpha.org/ceiic/', 'https://ceiic.socialalpha.org/'],
        patch: {
    ...
    {
        names: ['GIZ-FCDO StartUpWave', 'GIZ–FCDO StartUpWave', 'GIZâ€“FCDO StartUpWave', 'StartupWave Virtual Incubation Platform'],
        links: ['https://www.giz.de/en/worldwidegiz/india.html', 'https://startupwave.co/'],
        patch: {
    ...
    {
        names: ['World Bank Group Startup Financing', 'IFC Startup Catalyst'],
        links: ['https://www.ifc.org/en/what-we-do/sector-expertise/disruptive-technologies-and-funds', 'https://www.ifc.org/en/what-we-do/sector-expertise/venture-capital/startup-catalyst'],
        patch: {
    ...
    {
        names: ['Youth Co:Lab'],
        links: ['https://www.youthcolab.org/'],
        patch: {
            name: 'Youth Co:Lab',
    ...
    {
        names: ['UNIDO Global Cleantech Innovation Programme'],
        links: ['https://www.unido.org/cleantech', 'https://www.unido.org/GCIP'],
        patch: {
    ...
    {
        names: ['HDFC Bank Parivartan Start-up Grants (FY26)', 'HDFC Bank Parivartan Start-up Grants'],
        links: ['https://www.hdfcbank.com/personal/useful-links/social-initiatives/parivartan', 'https://www.hdfcbank.com/personal/about-us/news-room/press-release/2024/hdfc-bank-parivartan-announces-startup-grants-for-30-incubators'],
        patch: {
